...
Pet.create(name: 'lola', kind: 'cat',age: 13, user_id: 1, color: 'tortoiseshell grey', hair:'short', image:'assets/marko-blazevic-219788-unsplash.jpg')
Pet.create(name: 'tookie', kind: 'cat',age: 13, user_id: 1, color: 'tortoiseshell', hair:'short', image:'assets/ramiz-dedakovic-1328836-unsplash.jpg')
Pet.create(name: 'zoey', kind: 'dog', age: 8, user_id: 1, color: 'white', hair:'medium', image:'assets/ipet-photo-1061142-unsplash.jpg')
Pet.create(name: 'simon', kind: 'dog',age: 12, user_id: 2, color: 'grey', hair:'wirey', image:'assets/jorge-zapata-636083-unsplash.jpg')
Pet.create(name: 'caillie', kind: 'dog',age: 3, user_id: 2, color: 'black', hair:'wirey', image:'assets/cody-board-977975-unsplash.jpg')
Pet.create(name: 'leo', kind: 'dog',age: 7, user_id: 3, color: 'black and white', hair:'long', image:'assets/derek-arguello-722599-unsplash.jpg')
Pet.create(name: 'bea', kind: 'dog',age: 15, user_id: 4, color: 'brown, white, black', hair:'medium', image:'assets/sara-kurfess-1613487-unsplash.jpg')
Pet.create(name: 'mister', kind: 'cat',age: 2, user_id: 4, color: 'orange', hair:'long', image:'assets/lemoning-lee-759904-unsplash.jpg')
Pet.create(name: 'mufasa', kind: 'cat',age: 2, user_id: 4, color: 'orange', hair:'long', image:'assets/jae-park-1198084-unsplash.jpg')
